        ...
        <Card className="overflow-hidden shadow-lg">
          <CardHeader className="bg-gray-900 text-white">
            ...
            <CardDescription className="text-gray-300">
              Join our platform and showcase your colony to potential new Comers.
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <div className='space-y-4'>
              <div className="space-y-2">
                <label htmlFor="companyName" className="text-sm font-medium text-gray-700">Colony Name</label>
                <Input
                  type="text"
                  id="companyName"
